...
> **Desenvolvido por:** Léo Ramalho - [Twister POE no YouTube](https://www.google.com/search?q=https://www.youtube.com/%40twisterpoe)  
...
O jogo **Path of Exile 2** deve estar configurado em modo:
  ...
  * `Windowed` (Janela) **OU**
  * `Windowed Fullscreen` (Janela em Tela Cheia)
    *(Em Tela Cheia Exclusiva o overlay não aparecerá).*
