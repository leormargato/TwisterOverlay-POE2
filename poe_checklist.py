...
ACTS_DATA = {
    ...
    "Ato 4": [
        ...
        ("Profundezas Vulcânicas: Mate Krutog", "item", "#cccccc"),
        ("Baía Ancoreta: Fragmento de Mapa", "item", "#ff5555"),
        ("Baía Ancoretaa: Navio Abandonado (Joalheiro)", "item", "#55ff55"),
    ...
    "Interlúdio": [
        ...
        ("O Bosque Sable -> Holten", "item", "#cccccc"),
        ...
        ("Piscinas de Khatal -> Santuário Sel Khari", "item", "#cccccc"),
