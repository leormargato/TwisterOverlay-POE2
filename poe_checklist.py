...
ACTS_DATA = {
    "Ato 1": [
        ("ATO 1 - GRELWOOD", "header"),
        ("Clearfell -> Mud Burrow", "item"),
        ("Matar Bruxa de Gelo (+10% Cold Res)", "item"),
        ("Matar Chefe Mud Burrow -> Grelwood", "item"),
        ("Grelwood: Achar Waypoint", "item"),
        ("Opcional: Waypoint Grim Tangle", "item"),
        ("Opcional: Waypoint Red Vale", "item"),
        ("Falar com NPC -> Red Vale", "item"),
        ("Red Vale: 3 Fragmentos -> Rust King", "item"),
        ("Voltar Clearfell: Ferreiro (Runas)", "item"),
        ("Grelwood -> Libertar Sin", "item"),
        ("Grim Tangle -> Matar Boss", "item"),
        ("Cemetery of Eternals: Falar NPC", "item"),
        ("Matar Chefe Tomb of Consort", "item"),
        ("Matar Chefe Mausoleu", "item"),
        ("Matar Chefe Cemitério -> Hunting Grounds", "item"),
        ("Voltar Clearfell (Entregar Quests)", "item"),
        ("ATO 1 - HUNTING GROUNDS", "header"),
        ("Opcional: Waypoint Ogham Farmlands", "item"),
        ("Freythorn: King of Mists (+30 Spirit)", "item"),
        ("Matar Crowbell (Hunting Grounds)", "item"),
        ("Ogham Farmlands -> Una's Lute", "item"),
        ("Ogham Village -> Renly's Workshop", "item"),
        ("IMPORTANTE: Liberar Salvage Bench", "header"),
        ("Matar Executor -> Libertar NPC", "item"),
        ("Manor Ramparts WP -> Clearfell", "item"),
        ("Ogham Manor -> Candlemass (+Life)", "item"),
        ("Matar Geonor (Chefe Ato 1)", "item"),
    ],
    "Ato 2": [
        ("ATO 2 - VASTIRI", "header"),
        ("Vastiri Outskirts: Falar com Zarka", "item"),
        ("Mate o Rathbreaker", "item"),
        ...
        ("Halani Gates: Mate L'im the Impaler", "item"),
        ...
        ("KETH & TITANS", "header"),
        ("Ardura -> Keth: Mate Kabala (+2 Pontos)", "item"),
        ("Lost City: Kabala Clan Relic", "item"),
        ("Buried Shrines: Azarian (Essence Water)", "item"),
        ("Valley of Titans: Relic Altar (+Charm)", "item"),
        ...
        ("Ardura: Fale com Sin -> Ato 3", "item"),
    ],
    "Ato 3": [
        ("ATO 3 - JUNGLE START", "header"),
        ("Sandswept Marsh: Rootdredge (Skill Gem)", "item"),
        ("Orok Campfire -> Lesser Jewellers Orb", "item"),
        ("Jungle Ruins: Mate Silverfist", "item"),
        ("Venom Crypts: Veneno Stun Threshold", "item"),
        ...
        ("Aggorat -> Black Chambers (Direita/Esq)", "item"),
        ("Black Chambers: Mate Doryani", "item"),
    ],
    "Ato 4": [
        ("ATO 4 - NÃO LINEAR", "header"),
        ...
        ("Ngakanu -> Heart of the Tribe: Tavakai", "item"),
    ],
    "Interlúdio": [
        ("INTERLÚDIO", "header"),
        ("INTERLÚDIO - CURSE OF HOLTEN", "header"),
